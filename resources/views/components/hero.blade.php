        ...
        <div id="content" class="row gx-5 align-items-center">
            ...
            <div class="col-xxl-5">
                <div class="text-center text-xxl-start">
                    <div id="keyLine" class="badge bg-gradient-primary-to-secondary text-white mb-4"></div>
                    ...
                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                        <a id="cv2link" target="_blank" class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="{{ url('/resume') }}">Resume</a>
            ...
            <div class="col-xxl-7">
                <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                    <div class="profile" style="background-image: url('{{ $background }}');">
                        <img id="profileImage" class="profile-img" src="{{ $profileImage }}" alt="profile">
                    </div>
                </div>
            </div>
